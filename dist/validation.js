 ...
 */
export const validateMeterReadings = (coldWater, hotWater) => {
 ...
 */
export const validateReadingsInputFormat = (input) => {
 ...
 */
export const validateUserData = (firstName, lastName, username) => {
